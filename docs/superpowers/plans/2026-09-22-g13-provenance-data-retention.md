...
**Files:**
- Modify: `R/fit.R`, `R/design.R`, `R/bootstrap.R`, `R/measurement.R`, `R/measurement-assessment.R`, `R/groups.R`, `R/missing-data.R`, `R/summary.R`, and `man/fit_states.Rd`
